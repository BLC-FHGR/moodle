...
class restore_questions_parser_processor extends grouped_parser_processor {
    /** @var string path in the questions.xml backup file to question categories. */
    protected const CATEGORY_PATH = '/question_categories/question_category';

    /** @var string path in the questions.xml to question elements within question_category (Moodle 4.0+). */
    ...
    /** @var string path in the questions.xml to question elements within question_category (before Moodle 4.0). */
